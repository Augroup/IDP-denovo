...
if (defined($opt_d)) {
	...
	if (0) {
	    ...
	    $FP = new IO::File("| /Shared/Au/shuhfu/idpdenovo_test/idpdenovo-v.2/plugins/gmap-2014-12-24/../BIN/bin/get-genome -D $opt_D -d $opt_d > get-genome.out");
	} else {
	    $FP = new IO::File("| /Shared/Au/shuhfu/idpdenovo_test/idpdenovo-v.2/plugins/gmap-2014-12-24/../BIN/bin/get-genome -d $opt_d > get-genome.out");
	}
